                    ...
                    <div className="row">
                        <div className="col-xl-4 col-lg-4 col-md-6">
                            <div className="pricing-wrapper  single-pricing text-center mb-30">
                                ...
                                <div className="price-count">
                                    <h1><span className="usd">$</span>500</h1>
                                </div>
                                <div className="pricing-button">
                                    <Link to="#"> <span className="pricings-button">select plan <i className="far fa-long-arrow-right"></i></span> </Link>
                                </div>
                            </div>
                        </div>
                        <div className="col-xl-4 col-lg-4 col-md-6">
                            <div className="pricing-wrapper single-pricing active text-center mb-30">
                                ...
                                <div className="price-count">
                                    <h1><span className="usd">$</span>600</h1>
                                </div>
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6">
                            <div className="pricing-wrapper single-pricing text-center mb-30">
                                ...
                                <div className="price-count">
                                    <h1><span className="usd">$</span>800</h1>
                                </div>
                                <div className="pricing-button">
                                    <Link to="#"> <span className="pricings-button">select plan <i className="far fa-long-arrow-right"></i></span> </Link>
                                </div>
